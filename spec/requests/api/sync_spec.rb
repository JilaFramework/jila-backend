...
RSpec.describe 'api/sync', type: :request do
  ...
  let!(:entry) { Entry.create entry_word: 'Jalangardi', word_type: 'noun', meaning: 'Goanna', 
  ...
  path '/api/sync/image_credits' do
    ...
    get('image_credits sync') do
      ...
      response(200, 'successful') do
        ...
        let!(:image_credit) {ImageCredit.create(attribution_text: 'Saltwater Crocodile - MR Jordan Woodside - CC BY-SA 3.0',
