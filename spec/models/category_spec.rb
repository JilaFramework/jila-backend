...
RSpec.describe Category, :type => :model do
  ...
  describe :image_game_suitable? do
    ...
    let!(:entry1) { Entry.create entry_word: 'one', word_type: 'noun', translation: '1', image_file_name: 'image1.png', categories: [category] }
    let!(:entry2) { Entry.create entry_word: 'two', word_type: 'noun', translation: '2', image_file_name: 'image2.png', categories: [category] }
    let!(:entry3) { Entry.create entry_word: 'three', word_type: 'noun', translation: '3', image_file_name: 'image3.png', categories: [category] }
    let!(:entry_no_image) { Entry.create entry_word: 'noimage', word_type: 'noun', translation: 'noimage', image_file_name: nil, categories: [category] }

    context 'when 4 or more entries have images' do
      let!(:entry4) { Entry.create entry_word: 'four', word_type: 'noun', translation: '4', image_file_name: 'image4.png', categories: [category] }
  ...
  describe :audio_game_suitable? do
    let!(:category) { Category.create name: 'testCategory' }
    let!(:entry1) { Entry.create entry_word: 'one', word_type: 'noun', translation: '1', audio_file_name: 'audio1.png', categories: [category] }
    let!(:entry_no_audio) { Entry.create entry_word: 'noaudio', word_type: 'noun', translation: 'noaudio', audio_file_name: nil, categories: [category] }

    context 'when 2 or more entries have audio' do
      let!(:entry2) { Entry.create entry_word: 'two', word_type: 'noun', translation: '2', audio_file_name: 'audio2.png', categories: [category] }
